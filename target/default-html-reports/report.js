...
formatter.match({
  "location": "com.Nuvolar.testScripts.itemChartStepDefs.search_for(java.lang.String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "com.Nuvolar.testScripts.itemChartStepDefs.add_first_hat_to_Cart_with_quantity(int,int)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "com.Nuvolar.testScripts.itemChartStepDefs.open_cart_and_assert_total_price_and_quantity_are_correct()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "com.Nuvolar.testScripts.itemChartStepDefs.change_the_quantity_for_to_item(java.lang.String,int)"
});
formatter.result({
  "status": "passed"
});
